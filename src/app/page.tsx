      ...
      <div className="w-full md:w-1/4 p-4 md:p-6 bg-black-100 border-shadow">
        <div className="md:sticky md:top-6">
          ...
          <div className="flex space-x-4 mb-4">
            <Link href="https://www.linkedin.com/in/kristian-alex-kelly/" target="_blank" rel="noopener noreferrer">
              <svg className="w-12 h-12 text-blue-500 hover:text-blue-600" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <Link href="https://github.com/LordCat" target="_blank" rel="noopener noreferrer">
              <svg className="w-12 h-12 text-gray-800 hover:text-gray-900" fill="white" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <Link href="mailto:kristianalexkelly@gmail.com">
              <svg className="w-12 h-12 text-green-700 hover:text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
